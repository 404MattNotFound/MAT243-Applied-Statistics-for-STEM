...
plt.title('Histogram of points scored by the Boston Celtics in 2013 to 2015', fontsize=18)
...
# Scatterplot
plt.title('Scatterplot of points scored by the Boston Celtics in 2013 to 2015', fontsize=18)
...
# Now the coach wants you to prepare one plot that provides a visual of the differences in the distribution of points scored by the assigned team and your team. The code below provides two possible visuals. 
...
away_games = your_team_df[your_team_df['game_location']=='A'].copy()

mean = away_games['pts'].mean()
median = away_games['pts'].median()
variance = away_games['pts'].var()
stdeviation = away_games['pts'].std()
...
# The management wants to you to calculate a 95% confidence interval for the average relative skill of all teams in 2013-2015. You will use the variable 'elo_n' to respresent the relative skill of the teams. The code block below calculates the mean and the standard deviation.
...
print("The correct choice is choice number 2.")
...
# calculate the mean of relative skill
mean = assigned_years_league_df['elo_n'].mean()

# calculate the standard deviation of relative skill
